...
class StorageConfig(
    ...
    @Bean
    fun spendooS3Client(spendooCreds: StaticCredentialsProvider): S3Client =
        buildClient(props.spendoo.endpoint, spendooCreds)

    @Bean
    fun spendooCreds(): StaticCredentialsProvider {
        return StaticCredentialsProvider.create(AwsBasicCredentials.create(props.spendoo.key, props.spendoo.secret))
    }
